    ...
    return ( 
        <div className="banner d-flex justify-content-center align-items-center" style={{ 
            ...
            <div id="banner_creature">
                <img src={CreatureSVG} style={{width: '25vw', bottom: '0', right: '20%'}} className="position-absolute" id="banner_creature_body" alt=""/>
                <img src={CreatureFirstArm} style={{width: '5vw', bottom: '-2%', right: '40%', transform: 'rotate(-10deg)'}} className="position-absolute" id="banner_creature_arm1" alt=""/>
                <img src={CreatureSecondArm} style={{width: '5vw', bottom: '-2%', right: '20%', transform: 'rotate(10deg)'}} className="position-absolute" id="banner_creature_arm2" alt=""/>
            </div>
        </div>
     );
}
