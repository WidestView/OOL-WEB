            ...
            <div className="row">
                ...
                <div className="col-12 h-100 scene-body d-flex justify-content-center">
                    <div className="content col-12 col-lg-7 p-5 rounded text-titillium">
                        <h1 className="header text-primary text-center font-weight-bold mt-n3">401</h1>
                        <div className="col-12 col-lg-5 mx-auto">
                            <div className="d-flex justify-content-center">
                                <h4 className="text-center font-weight-bold text-primary mb-3 pb-0">USUÁRIO NÃO AUTORIZADO!</h4>
                            </div>
                            <h5 className="text-center text-dark mt-0 pt-0">*dois seguranças bombados te tiram da sala...*</h5>
                        </div>
